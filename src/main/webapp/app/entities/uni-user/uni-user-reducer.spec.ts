...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './uni-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNIUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNIUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNIUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNIUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNIUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNIUSER actions', async () => {
      const expectedActions = [
        {
