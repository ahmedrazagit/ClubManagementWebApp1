...
import uk.ac.bham.teamproject.domain.Blog;
import uk.ac.bham.teamproject.repository.BlogRepository;
import uk.ac.bham.teamproject.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uk.ac.bham.teamproject.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
@Transactional
