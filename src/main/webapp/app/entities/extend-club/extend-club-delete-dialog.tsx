...
import { getEntity, deleteEntity } from './extend-club.reducer';

export const ExtendClubDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(extendClubEntity.id));
  };

  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="extendClubDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-extendClub" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
...
export default ExtendClubDeleteDialog;
