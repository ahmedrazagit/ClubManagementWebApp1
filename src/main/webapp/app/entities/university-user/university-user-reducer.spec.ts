...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNIVERSITYUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNIVERSITYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNIVERSITYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNIVERSITYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNIVERSITYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNIVERSITYUSER actions', async () => {
      const expectedActions = [
        {
