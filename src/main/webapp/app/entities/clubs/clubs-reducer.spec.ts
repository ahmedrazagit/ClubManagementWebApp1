...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './clubs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLUBS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLUBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLUBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLUBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLUBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLUBS actions', async () => {
      const expectedActions = [
        {
