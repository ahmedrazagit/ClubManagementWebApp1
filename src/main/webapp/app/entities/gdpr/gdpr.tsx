      ...
      <div className="table-responsive">
        ...
        >
          <pre>
            ...
            <p>
              When you sign up to Clubping, we may send your data to, and also use the resulting information from registration details to
              give it to our identity protection department to prevent identity theft and any sort of fraud.
            </p>
            ...
            <p>
              ...
              variety of security measures, such as encryption, firewalls, access controls,and intrusion detection systems. Access to data
              is restricted only to authorised personnel who require it for their job functions, and all access to data is monitored and
              logged.
            </p>
            <p>
              {' '}
            ...
            <p>
              ...
              data by completely removing it from our database unless you renew your account which you will be prompted by us to do so 6
              months prior from the data of last renewal.
            </p>
            ...
            <p>
              ...
              small fee for this service. The right to rectification - You have the right to request that Clubping correct any information
              you believe is inaccurate. You also have the right to request Clubping to complete information you believe is incomplete. The
              right to erasure — You have the right to request that Clubping erase your personal data, under certain conditions. The right
              to restrict processing - You have the right to request that Clubping restrict the processing of your personal data, under
              certain conditions. The right to object to processing - You have the right to object to Clubping’s processing of your personal
              data, under certain conditions. The right to data portability - You have the right to request that Clubping transfer the data
              that we have collected to another organisation, or directly to you, under certain conditions. If you make a request, we have
              one month to respond to you. If you would like to exercise any of these rights, please contact us at our email:
              clubpingforbusiness@gmail.com
            </p>
            ...
            <li>
              ...
              links you followed and information about your browser, device, and your IP address. Clubping sometimes shares some limited
              aspects of this data with third parties for advertising purposes. We may also share online data collected through cookies with
              our advertising partners. This means that when you visit another website, you may be shown advertising based on your browsing
            ...
            <p>
              The Clubping website contains links to other websites. Our privacy policy applies only to our website, so if you click on a
            ...
            <p>
              If you have any questions about Clubping’s privacy policy, the data we hold on you, or you would like to exercise one of your
              data protection rights, please do not hesitate to contact us.
            </p>

            <p>
              Email us at: clubpingforbusiness@gmail.com Or contact any of our entire team: Ahmed Raza : axa1874@student.bham.ac.uk Meena
              Muthukumar : mxm1397@student.bham.ac.uk Kavin Babu : kxb195@student.bham.ac.uk Rayna Felix : rxf138@student.bham.ac.uk Rohit
              Manikuttan : rmu186@student.bham.ac.uk Zhange Luo : zxl084@student.bham.ac.uk How to contact the appropriate authority Should
              you wish to report a complaint or if you feel that Clubping has not addressed your concern in a satisfactory manner, you may
