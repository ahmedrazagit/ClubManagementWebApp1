...
export const ClubsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="teamprojectApp.clubs.delete.question">
        <Translate contentKey="teamprojectApp.clubs.delete.question" interpolate={{ id: clubsEntity.id }}>
