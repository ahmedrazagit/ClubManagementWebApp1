...
describe('Event e2e test', () => {
  ...
  const eventSample = { date: '2023-03-13T04:08:20.815Z', location: 'Cotton connecting Small', description: 'Saint Loan' };
  ...
  describe('new Event page', () => {
    ...
    it('should create an instance of Event', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2023-03-13T03:09').blur().should('have.value', '2023-03-13T03:09');

      cy.get(`[data-cy="location"]`).type('Rustic Technician').should('have.value', 'Rustic Technician');

      cy.get(`[data-cy="description"]`).type('24/7XXXXXX').should('have.value', '24/7XXXXXX');
