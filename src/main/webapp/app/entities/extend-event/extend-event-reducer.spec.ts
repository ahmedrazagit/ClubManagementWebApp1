...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXTENDEVENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXTENDEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXTENDEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXTENDEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXTENDEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXTENDEVENT actions', async () => {
      const expectedActions = [
        {
