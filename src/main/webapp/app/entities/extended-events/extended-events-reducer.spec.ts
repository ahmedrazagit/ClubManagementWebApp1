...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXTENDEDEVENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXTENDEDEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXTENDEDEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXTENDEDEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXTENDEDEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXTENDEDEVENTS actions', async () => {
      const expectedActions = [
        {
