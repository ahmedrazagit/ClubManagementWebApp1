    ...
    <div>
      ...
      {/*<div className="block">
        ...
        <div className="writing">
          <div contentEditable="true" className="textarea" spellCheck="false">
        ...
        <div className="comment">
          ...
          <div className="content">
            <p>Actually, now that I try out the links on my message, above, none of them take me to the secure site.
              Only my shortcut on my desktop, which I created years ago.</p>
          </div>
          <div className="footer">
            <button className="btn"><i className="ri-emotion-line"></i></button>
            <div className="reactions">
              <button className="btn react"><img
                src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/apple/325/thumbs-up_1f44d.png"
                alt=""/>4</button>
              <button className="btn react"><img
                src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/apple/325/angry-face-with-horns_1f47f.png"
                alt=""/>1</button>
            </div>
            <div className="divider"></div>
            <a href="#">Reply</a>
        ...
        <div>
          ...
          <div className="reply comment">
            ...
            <div className="footer">
              ...
              <div className="reactions">
                <button className="btn react"><img
                  src="https://cdn-0.emojis.wiki/emoji-pics/apple/smiling-face-with-heart-eyes-apple.png" alt=""/>2
                </button>
              </div>
              <div className="divider"></div>
              <a href="#">Reply</a>
