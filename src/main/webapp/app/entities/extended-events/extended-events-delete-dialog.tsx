...
import { getEntity, deleteEntity } from './extended-events.reducer';

export const ExtendedEventsDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(extendedEventsEntity.id));
  };

  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="extendedEventsDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-extendedEvents" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
...
export default ExtendedEventsDeleteDialog;
