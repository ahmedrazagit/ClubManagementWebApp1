...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXTENDCLUB_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXTENDCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXTENDCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXTENDCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXTENDCLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXTENDCLUB actions', async () => {
      const expectedActions = [
        {
